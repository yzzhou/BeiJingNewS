...
public class TopicMenuDetailPager extends MenuDetailBasePager {
    private NewsMenuDetailPager.NewsMenuDetailPagerAdapter adapter;
...
//        textView.setTextColor(Color.RED);
        View view = View.inflate(context, R.layout.pager_topic_menu_datail,null);
    ...
    public void initData() {
        ...
        indicator.setupWithViewPager(viewPager_news);
